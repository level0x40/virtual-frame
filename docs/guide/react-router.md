...
<svg viewBox="0 0 720 546" xmlns="http://www.w3.org/2000/svg" style="max-width:720px;width:100%;height:auto;font-family:system-ui,sans-serif">
  ...
  <text x="40" y="48" font-size="14" font-weight="700" fill="#6964ff">Server (route loader)</text>
  ...
  <text x="360" y="210" text-anchor="middle" font-size="10" fill="currentColor" opacity="0.9">Serialised and delivered as loader data</text>
...
- **[React Router example](https://github.com/level0x40/virtual-frame/tree/main/examples/react-router-host)** — `pnpm example:react-router`
