/**
 * @virtual-frame/nuxt/server — Server-only entry.
 *
 ...
 * Nitro server routes / `useAsyncData` server functions.
 */
 ...
 *
 * Call this inside a Nitro server route and return the result.
 * The page receives these props via `useAsyncData()` or `useFetch()`.
 *
 * ```ts
 * // server/api/frame.ts
 * import {
