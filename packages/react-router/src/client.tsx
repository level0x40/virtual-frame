...
/**
 * Virtual Frame component for React Router.
 *
 ...
 * The bridge script must be included in the remote React Router app.
 *
...
export function VirtualFrame({
  ...
  useEffect(() => {
    ...
    if (shared) {
      ...
      // Insert the iframe into the DOM.  The remote React Router app
      // loads at its own origin, hydrates correctly, and the bridge
      // script auto-initialises for cross-origin mirroring.
