  ...
  return (
    <div className="layout">
      <div className="panel info">
        ...
        <code>fetchVirtualFrame()</code> in a <code>createServerFn</code>{" "}
        handler to fetch the remote TanStack Start page during SSR.{" "}
        <code>prepareVirtualFrameProps()</code> wraps the content in
        declarative shadow DOM for instant display. On the client, a hidden{" "}
        <code>&lt;iframe src&gt;</code> loads the remote app at its real
        origin — the <strong>cross-origin bridge</strong> handles live DOM
        mirroring via <code>postMessage</code>. Two{" "}
        <code>&lt;VirtualFrame&gt;</code> components are rendered — one
        showing the full page, one showing only{" "}
